...
\begin{IEEEkeywords}
mp-hard, task, scheduling, algorithm, branch-and-bound, A*, multithreading, parallelisation 
\end{IEEEkeywords}
...
The team adopted a democratic stance when making decisions. No team member had more influence when it came to voting on a decision. Voting was only carried out when the team was split in views, and members felt that voting was most fair in carrying out decision making.
...
Initialise new atomic long variable bestUpperBound 
Initialise new atomic boolean variable done = false
Initialise empty root node and add it to openNodes
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.4\textwidth]{images/fig4.png}}
\caption{Final Iteration of the Graphical User Interface.}
\label{fig}
\end{figure}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.4\textwidth]{images/fig5.png}}
\caption{Zoom and drag feature of the Graphical User Interface.}
\label{fig}
\end{figure}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.4\textwidth]{images/fig6.png}}
\caption{Intuitive illustration of task information.}
\label{fig}
\end{figure}
